...
<body>
	...
	<?php
		...
		$incr1=(($navigator["browser"]==='CHROME')?49:(($navigator["browser"]==='IE')?48:40));//
/**/
		$i=0;
		$cc=1;
		while ($i<=0){
