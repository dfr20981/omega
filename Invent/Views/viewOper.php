...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/code/inv_estilo.css">
...
<body>
          ...
          <form method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="form-group row" style="margin-bottom:0em;">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <input class="form-control form-control-sm" type="text" name="nombre" placeholder="Ingrese el Nombre del material, elemento o producto" value="" id="frm_newEle_nom" />
              </div>      
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <label class="control-label">Categoria:</label>
                <input class="form-control form-control-sm" type="text" name="categoria" placeholder="Ingrese Categoria" value=""  id="frm_newEle_catego"/> 
              </div>      
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <label class="control-label">Marca:</label>
                <input class="form-control form-control-sm" type="text" name="marca" placeholder="Ingrese la Marca" value=""  id="frm_newEle_marca"/>    
              </div>
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <label for="basic-url">Modelo:</label>
                <div class="input-group mb-1">
                   <input type="text" class="form-control form-control-sm" name="modelo" placeholder="Ingresa Modelo" aria-describedby="basic-addon3"
                   value="" id="frm_newEle_modelo"/>
                </div> 
              </div>      
            </div>
            <div class="form-group row" style="margin-bottom:0em;">
              <div class="col-sm-12 col-md-6 col-lg-3 col-xl-2">
                <label for="basic-url">Capacidad:</label>
                <div class="input-group mb-1">
                   <input type="text" class="form-control form-control-sm" name="capacidad" placeholder="" aria-describedby="basic-addon3"
                   value="" id="frm_newEle_capaci"/>
                </div> 
              </div>      
              ...
              <div class="col-sm-12 col-md-6 col-lg-3 col-xl-2">
                  <label for="basic-url">Altura:</label>
                  <div class="input-group input-group-sm mb-1">
                     <input type="text" class="form-control" name="altura" placeholder=""  aria-describedby="basic-addon3"
                     value="" id="frm_newEle_alt"/>
                     <div class="input-group-prepend">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-2">
                    <label for="basic-url">Profundidad:</label>
                    <div class="input-group input-group-sm mb-1">
                       <input type="text" class="form-control form-control-sm" name="profundidad" placeholder=""  aria-describedby="basic-addon3"
                       value="" id="frm_newEle_prof"/>
                       <div class="input-group-prepend">
                          <span class="input-group-text" id="basic-addon3">cm</span>
                       </div>
                    </div>      
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-2">
                  <label for="basic-url">Peso:</label>
                  <div class="input-group input-group-sm mb-1">
                     <input type="text" class="form-control" name="peso" placeholder="Ingrese el Peso"  aria-describedby="basic-addon3"
                     value="" id="frm_newEle_peso"/>
                     <div class="input-group-prepend">
            ...
            <div class="form-group row" style="margin-bottom:0em;">  
                <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
                  <label class="control-label">Necesita Baterias:</label>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                  <label class="control-label">Necesita Corriente Electrica:</label>
                  <select class="form-control form-control-sm" name="conexion" id="frm_newEle_elect"   value="">
                    <option value="0"  selected>No</option>
                    <option value="1">Si</option>
                  </select>
                </div>      
                <div id="div_frm_newEle_precio" class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                  <label class="control-label">Precio:</label>
                  <input class="form-control form-control-sm" type="text" name="precio" placeholder="Ingrese Precio" id="frm_newEle_precio"/>
                </div>  
            </div>  
          <!--     
  ...
  <div class="modal fade-modal-xl"  tabindex="-1" role="dialog" id="mdl_PosicionElemt" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header bg-dark">
  ...
  <div class="modal fade-modal-xl"  tabindex="-1" role="dialog" id="mdl_editVale" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header bg-dark">
  ...
  <script>
    var parametors={usu:"O",viewColVales:[8]};
    feather.replace()
  </script>
