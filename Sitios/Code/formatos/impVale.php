		...
		$primero='<div class="primer">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
					<span class="tit02">VALE DE '.(( $head->tipo=='E')?'ENTRADA':'SALIDA').' '.$head->id_doc.'</span>
				</div>
			</div>	
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		...
		while ($i<=0){
			...
			while ($y<=0){
				...
				$trHtml=$trHtml.'<tr>
									...
									<td class="tdText01">'.$detalle[0]->id_doc.'</td>
									<td class="tdText2">'.$detalle[0]->cant.'</td>
						...
						<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<table style="width: 100%;">
								<thead class="thRow">
									<tr>
										<th class="thTit">#</th>
										<th class="thTit">ID</th>
										<th class="thTit">Cantidad</th>
										<th class="thTit">Unidad</th>
										<th class="thTit" style="width: 310px;">Descripción</th>
